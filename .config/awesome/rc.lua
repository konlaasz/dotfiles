...
mytextclock = wibox.widget.textclock(" %y.%m.%d %V.%u %H:%M ")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " α ", " β ", " γ ", " δ " }, s, { awful.layout.layouts[1], awful.layout.layouts[2], awful.layout.layouts[2], awful.layout.layouts[2] })
...
globalkeys = gears.table.join(
    ...
    -- Backlight control
    awful.key({ }, "XF86MonBrightnessDown", function () awful.spawn.with_shell("light -U 2") end, {description = "increase screen brightness", group = "screen"}),
    awful.key({ }, "XF86MonBrightnessUp", function () awful.spawn.with_shell("light -A 2") end, {description = "decrease screen brightness", group = "screen"}),
